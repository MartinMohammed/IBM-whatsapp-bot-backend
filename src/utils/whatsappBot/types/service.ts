...
export enum Services {
  ...
  /**
   * Retrieves business compliance information
   */
  ...
  /**
   * Endpoints to upload, retrieve, or delete media
   */
  MEDIA = "media",

  /**
   * Endpoint to send text messages, media (audio, documents, images, and video),
   * and message templates to your customers.
